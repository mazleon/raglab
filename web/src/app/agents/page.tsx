    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted mt-1">Configure and manage AI agent workflows</p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center py-20 glass-card rounded-2xl border-dashed border-base">
        ...
        <h3 className="text-xl font-semibold text-muted mb-2">No agents configured</h3>
        <p className="text-sm text-subtle mb-8 max-w-md text-center">Create AI agents with custom prompts, tools, and model configurations</p>
        <button className="px-5 py-2.5 bg-gradient-to-r from-cyan-500 to-violet-600 text-white rounded-xl font-medium text-sm btn-glow-cyan active:scale-95">
          <span className="flex items-center space-x-2">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" /></svg>
