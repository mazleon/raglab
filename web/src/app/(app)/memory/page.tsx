    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted mt-1">Manage episodic, semantic, and working memory</p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center py-20 glass-card rounded-2xl border-dashed border-base">
        ...
        <h3 className="text-xl font-semibold text-muted mb-2">Memory timeline</h3>
        <p className="text-sm text-subtle mb-8 max-w-md text-center">Your agent&apos;s memories will appear here — episodic, semantic, and working memory</p>
