    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-white/40 mt-1">Compare RAGAS metrics, LLM-judge scores, and custom evaluations</p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center py-20 glass-card rounded-2xl border-dashed border-white/[0.06]">
        ...
        <h3 className="text-xl font-semibold text-white/70 mb-2">No evaluations yet</h3>
        <p className="text-sm text-white/30 mb-8 max-w-md text-center">Run evaluations to measure quality metrics including faithfulness, relevancy, and recall</p>
