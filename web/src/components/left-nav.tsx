  ...
  return (
    ...
    >
      <div className="h-full overflow-y-auto py-4 pb-24">
        {/* Section label */}
        <div className="px-6 pb-3 mb-3 mx-3 border-b border-base">
          <p className="text-[10px] font-semibold uppercase tracking-[0.15em] text-subtle">Navigation</p>
        </div>
            ...
            return (
              ...
              >
                ...
                <Icon className={cn(
                  ...
                  isActive ? 'text-cyan-400' : 'text-muted group-hover:text-muted'
                )} />
        ...
        {/* Footer */}
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-base bg-gradient-to-t from-black/20 to-transparent">
          <div className="flex items-center space-x-3 px-3 py-2 rounded-lg surface">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-semibold text-muted truncate">RAGLab v0.1</p>
              <p className="text-[10px] text-subtle truncate">Agentic Intelligence</p>
            </div>
          </div>
        </div>
      </div>
